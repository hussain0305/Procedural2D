...
{
    private static readonly string KeyPath = Application.persistentDataPath + "/aesKey.dat";
    private static readonly string IvPath = Application.persistentDataPath + "/aesIv.dat";
