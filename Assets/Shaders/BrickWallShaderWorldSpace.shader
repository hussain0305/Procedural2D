Shader "Abyss/BrickWallShaderWorldSpace"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                o.worldPos = mul(unity_ObjectToWorld, v.vertex).xy; // Get world position in XY plane
                return o;
            }
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                float localX = frac((worldPos.x + offset) / (brickWidth + _MortarHeight));
                float localY = frac(worldPos.y / (brickHeight + _MortarHeight));
